...
class NewsSettingController extends Controller
{
    public function index()
    {
        $settings = [
            ...
            'wakaf_article_url'  => SiteSetting::get('wakaf_article_url', '/berita/program-wakaf-al-quran-dan-buku'),
    ...
    public function update(Request $request)
    {
        $validated = $request->validate([
            ...
            'wakaf_article_url'  => 'nullable|string|max:255',
