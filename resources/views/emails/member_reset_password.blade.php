...
<body>
    <div class="container">
        ...
        <div class="header">
            ...
            <p style="color: #e2e8f0; margin: 4px 0 0 0; font-size: 11px;">Layanan Toko Buku &amp; Penerbitan</p>
        </div>
        ...
        <div class="content">
            ...
            <p>
                Kami menerima permintaan untuk mengatur ulang kata sandi akun Anda pada portal <strong>Penerbit PERSIS</strong>.
            </p>
            <p>
            ...
            <p style="margin-top: 24px; font-size: 12px; color: #64748b;">
                Jika tombol di atas tidak berfungsi, salin tautan berikut pada peramban web Anda:<br>
