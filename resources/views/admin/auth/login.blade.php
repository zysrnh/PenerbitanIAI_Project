    ...
    <div class="w-full max-w-sm">
        ...
        <div class="text-center mb-6">
            <a href="{{ url('/') }}" class="inline-block transition-transform duration-200 hover:scale-105" title="PERSIS PERS">
                <img src="{{ asset('images/logo/logo_persis_pers_full_official_transparent.png') }}" alt="PERSIS PERS" class="h-12 sm:h-14 w-auto mx-auto brightness-0 invert object-contain" />
            </a>
        ...
        <div class="bg-white rounded-sm shadow-xl border border-slate-200 p-6 sm:p-7">
            ...
            <form method="POST" action="{{ route('admin.login.submit') }}" class="space-y-4">
                ...
                <button 
                    type="submit" 
                    class="w-full py-2.5 bg-[#006830] hover:bg-[#032c21] text-white rounded-sm text-xs font-bold uppercase tracking-wider transition shadow-xs mt-2 flex items-center justify-center gap-2"
                >
            ...
            <div class="mt-5 pt-4 border-t border-slate-100 text-center text-xs text-slate-400">
                <a href="{{ url('/') }}" class="hover:text-slate-700 font-medium transition flex items-center justify-center gap-1.5">
