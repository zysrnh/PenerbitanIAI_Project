...
<body class="h-full antialiased flex flex-col items-center justify-center p-3.5 sm:p-6 bg-[#0a0f1d] text-slate-100 selection:bg-emerald-500 selection:text-white">
    ...
    <div class="w-full max-w-sm my-auto animate-smooth-in space-y-4">
        ...
        <div class="text-center space-y-1.5">
            ...
            <p class="text-xs text-slate-400 font-medium tracking-tight">Setel Ulang Kata Sandi Admin</p>
        </div>
        ...
        <div class="bg-white text-slate-800 rounded-sm shadow-2xl border border-slate-200 p-5 sm:p-7 space-y-4">
            ...
            <form method="POST" action="{{ route('admin.password.update') }}" class="space-y-3.5">
                @csrf
                ...
                <div class="space-y-1">
                    ...
                    <div class="relative">
                        ...
                        >
                            <i id="eyeNewIcon" class="fa-solid fa-eye text-xs"></i>
                        </button>
                    </div>
                </div>
            ...
            <div class="mt-4 pt-3.5 border-t border-slate-100 text-center">
                <a href="{{ route('admin.login') }}" class="text-xs text-slate-400 hover:text-slate-700 transition inline-flex items-center gap-1.5 py-1">
