        ...
        <div class="lg:col-span-8 space-y-5">
            ...
            <div class="bg-white p-5 rounded-sm border border-slate-200/90 shadow-2xs space-y-2">
                <div>
                    ...
                    <div class="flex items-center justify-between text-[11px] text-slate-400 mt-1 flex-wrap gap-1">
                        <span class="flex items-center gap-1.5">
                            <i class="fa-solid fa-wand-magic-sparkles text-emerald-600 text-xs"></i>
                            <span>URL slug dan ringkasan singkat (excerpt) otomatis diperbarui dari judul dan isi berita.</span>
                        </span>
                        <a href="{{ route('berita.show', $article->slug) }}" target="_blank" class="font-mono text-emerald-700 hover:underline flex items-center gap-1">
                            <span>/berita/{{ $article->slug }}</span>
            ...
            <div class="bg-white p-5 rounded-sm border border-slate-200/90 shadow-2xs space-y-2.5">
                ...
                <div class="space-y-1.5">
                    <input 
                        ...
                        value="{{ old('category_name', $article->category->name ?? 'Kabar Penerbitan') }}" 
