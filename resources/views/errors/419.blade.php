...
<head>
    ...
    <title>419 - Sesi Kedaluwarsa | PERSIS PERS</title>
...
<body class="min-h-screen bg-slate-100 flex items-center justify-center p-4 text-slate-800 select-none">
    <div class="max-w-md w-full bg-white rounded-sm border border-slate-200 shadow-xl p-6 sm:p-8 text-center space-y-5">
        ...
        <div class="space-y-1.5">
            <span class="text-xs font-mono font-bold text-amber-700 uppercase tracking-widest block">Error 419 • Sesi Berakhir</span>
            <h1 class="text-xl sm:text-2xl font-black text-slate-900 font-heading">
                Sesi Halaman Berakhir
            </h1>
            <p class="text-xs text-slate-500 leading-relaxed">
                Sesi halaman Anda telah kedaluwarsa karena tidak ada aktivitas dalam beberapa waktu. Silakan muat ulang halaman untuk melanjutkan.
            </p>
        </div>
