...
<head>
    ...
    <title>503 - Pemeliharaan Sistem | PERSIS PERS</title>
...
<body class="min-h-screen bg-slate-100 flex items-center justify-center p-4 text-slate-800 select-none">
    <div class="max-w-md w-full bg-white rounded-sm border border-slate-200 shadow-xl p-6 sm:p-8 text-center space-y-5">
        ...
        <div class="space-y-1.5">
            <span class="text-xs font-mono font-bold text-emerald-800 uppercase tracking-widest block">Error 503 • Pemeliharaan Sistem</span>
            <h1 class="text-xl sm:text-2xl font-black text-slate-900 font-heading">
                Sedang Ditingkatkan
            </h1>
            <p class="text-xs text-slate-500 leading-relaxed">
                Layanan IAI PERSIS PRESS sedang dalam pemeliharaan rutin atau peningkatan performa. Kami akan segera kembali dalam beberapa saat.
            </p>
        </div>

        <div class="pt-2">
            <button type="button" onclick="window.location.reload()" class="w-full py-2.5 bg-[#006830] hover:bg-[#032c21] text-white rounded-sm text-xs font-bold transition flex items-center justify-center gap-1.5 shadow-xs cursor-pointer">
