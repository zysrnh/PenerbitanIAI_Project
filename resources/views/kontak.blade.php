...
@section('content')
    ...
    <section class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-7 relative z-20">
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            <!-- Card 1: Kantor -->
            <div class="bg-white p-5 rounded-sm border border-slate-200 shadow-sm reveal-card flex items-start gap-3.5">
    ...
    <section class="py-14 sm:py-16">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            @if(session('success'))
                <div class="mb-8 p-5 rounded-sm bg-emerald-50 border border-emerald-200 text-emerald-900 shadow-sm animate-fade-in-up">
                    <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
                        ...
                        @if(session('wa_url'))
                            <a href="{{ session('wa_url') }}" target="_blank" class="px-4 py-2 bg-[#25D366] hover:bg-[#20bd5a] text-white rounded-sm text-xs font-bold transition flex items-center gap-2 shrink-0 shadow-xs">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
                ...
                <div class="lg:col-span-7 bg-white p-6 sm:p-8 rounded-sm border border-slate-200 shadow-sm reveal-card">
                    ...
                    <form method="POST" action="{{ route('kontak.store') }}" class="space-y-4">
                        ...
                        <div>
                            ...
                            <input 
                                ...
                                required
                                class="w-full px-3.5 py-2.5 text-xs sm:text-sm rounded-sm border border-slate-200 focus:outline-none focus:border-brand-700 focus:ring-1 focus:ring-brand-700 transition"
                            />
                        </div>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div>
                                ...
                                <select name="service_category" required class="w-full px-3.5 py-2.5 text-xs sm:text-sm rounded-sm border border-slate-200 focus:outline-none focus:border-brand-700 bg-white text-slate-700 font-medium">
                        ...
                        <div class="pt-2">
                            <button 
                                type="submit" 
                                class="w-full py-3.5 bg-brand-900 hover:bg-brand-950 text-white rounded-sm font-bold text-xs uppercase tracking-wider transition flex items-center justify-center gap-2 shadow-sm hover:shadow-md transform duration-200"
                            >
                ...
                <div class="lg:col-span-5 space-y-6">
                    ...
                    <!-- WhatsApp Box -->
                    <div class="bg-brand-950 text-white p-6 sm:p-7 rounded-sm border border-brand-900 shadow-md reveal-card">
                        <div class="flex items-center gap-3.5 mb-4">
                            <div class="w-11 h-11 rounded-sm bg-[#25D366] text-white flex items-center justify-center text-2xl shrink-0 shadow-sm">
                        ...
                        <a 
                            ...
                            target="_blank" 
                            class="w-full py-3 bg-[#25D366] hover:bg-[#20bd5a] text-white rounded-sm font-bold text-xs uppercase tracking-wider transition flex items-center justify-center gap-2.5 shadow-sm hover:shadow-lg transform duration-200"
                        >
                    ...
                    <!-- Google Maps Card -->
                    <div class="bg-white p-6 rounded-sm border border-slate-200 shadow-sm reveal-card">
                        ...
                        <div class="w-full h-64 rounded-sm overflow-hidden border border-slate-200">
                            <iframe 
                                src="{{ $settings['maps'] }}" 
                                width="100%" 
                                height="100%" 
