...
<body class="min-h-screen flex items-center justify-center p-4 bg-slate-50 antialiased text-slate-800">
    ...
    <div class="w-full max-w-sm">
        ...
        <div class="bg-white rounded-sm shadow-xl border border-slate-200 p-6 sm:p-7">
            ...
            @if(session('success'))
                <div class="mb-4 p-3 bg-emerald-50 border border-emerald-200 rounded-sm flex items-center gap-2 text-xs text-emerald-800 font-semibold">
            ...
            @if(session('error'))
                <div class="mb-4 p-3 bg-rose-50 border border-rose-200 rounded-sm flex items-center gap-2 text-xs text-rose-800 font-semibold">
            ...
            <form method="POST" action="{{ route('member.login.submit') }}" class="space-y-4">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="email" name="email" id="email"
                            ...
                            class="input-focus w-full pl-9 pr-3 py-2 text-xs sm:text-sm border border-slate-200 rounded-sm transition"
                            required autofocus>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="password" name="password" id="password"
                            ...
                            class="input-focus w-full pl-9 pr-10 py-2 text-xs sm:text-sm border border-slate-200 rounded-sm transition"
                            required>
                ...
                <!-- Submit -->
                <button type="submit"
                    class="w-full py-2.5 bg-[#006830] hover:bg-[#032c21] text-white font-bold text-xs uppercase tracking-wider rounded-sm transition flex items-center justify-center gap-2 shadow-xs mt-2 cursor-pointer">
            ...
            <div class="mt-4 pt-3 border-t border-slate-100 text-center space-y-2">
                ...
                <div>
                    <a href="{{ url('/') }}" class="text-xs text-slate-400 hover:text-slate-700 transition inline-flex items-center gap-1">
