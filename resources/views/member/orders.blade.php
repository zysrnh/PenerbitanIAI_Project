...
<body class="min-h-screen text-slate-800 antialiased bg-slate-100/70 flex">
    ...
    <aside id="member-sidebar" class="fixed top-0 left-0 bottom-0 w-64 brand-dark text-white flex flex-col justify-between z-50 transition-transform duration-300 ease-in-out border-r border-white/10 select-none -translate-x-full lg:translate-x-0">
        ...
        <div>
            <!-- Sidebar Brand Logo & Close Button (Mobile) -->
            <div class="px-5 py-4.5 border-b border-white/10 flex items-center justify-between">
                ...
                <button type="button" onclick="toggleSidebar()" class="lg:hidden p-1.5 text-emerald-300 hover:text-white rounded-sm hover:bg-white/10 transition" title="Tutup Menu">
                    <i class="fa-solid fa-xmark text-base"></i>
                </button>
            </div>

            <!-- User Profile Card in Sidebar -->
            <div class="px-5 py-3.5 border-b border-white/10 bg-black/15">
