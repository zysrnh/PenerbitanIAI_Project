...
<body class="h-full antialiased flex items-center justify-center p-4 bg-[#0a0f1d] selection:bg-emerald-500 selection:text-white">
    ...
    <div class="w-full max-w-sm">
        ...
        <div class="bg-white rounded-2xl shadow-xl border border-slate-200/80 p-6 sm:p-7">
            ...
            <form method="POST" action="<?php echo e(route('admin.login.submit')); ?>" class="space-y-3.5">
                <?php echo csrf_field(); ?>
            ...
            <div class="mt-5 pt-4 border-t border-slate-100 text-center text-xs text-slate-400">
                <a href="<?php echo e(url('/')); ?>" class="hover:text-slate-700 font-medium transition">&larr; Kembali ke Beranda</a>
            </div>
        </div>
    </div>
...
<?php /**PATH D:\Gawe\IAIPersis\penerbitan.iaibandung.ac.id\resources\views/admin/auth/login.blade.php ENDPATH**/ ?>