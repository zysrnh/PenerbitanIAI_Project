...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'IAI PERSIS PRESS | Penerbitan & Percetakan Kampus'); ?></title>
...
<body class="antialiased text-slate-800 bg-white selection:bg-brand-800 selection:text-white flex flex-col min-h-screen">
    ...
    <header class="sticky top-0 z-40 bg-white/95 backdrop-blur-md border-b border-slate-200/80 shadow-xs transition-all duration-300">
                ...
                <nav class="hidden lg:flex items-center gap-7">
                    ...
                    <div class="relative group">
                        ...
                        <div class="absolute left-0 top-full hidden group-hover:block w-56 bg-white border border-slate-200 rounded-lg shadow-xl py-2 z-50 animate-fade-in-up">
                            ...
                            <a href="<?php echo e(url('/#layanan')); ?>" class="block px-4 py-2 text-xs font-semibold text-slate-700 hover:bg-slate-50 hover:text-brand-900">Konversi KTI ke Buku</a>
                    ...
                    <a href="<?php echo e(url('/kontak')); ?>" class="<?php echo e(request()->routeIs('kontak') ? 'text-brand-900 font-bold border-b-2 border-brand-900 pb-1' : 'text-slate-700 hover:text-brand-900 font-semibold'); ?> text-xs tracking-wider uppercase transition">KONTAK</a>
                </nav>

                <!-- Header CTA Button -->
                <div class="hidden sm:flex items-center gap-3">
                    <a href="<?php echo e(url('/kontak')); ?>" class="px-5 py-2.5 bg-brand-900 hover:bg-brand-950 text-white rounded-lg font-bold text-xs tracking-wider uppercase transition flex items-center gap-2 shadow-xs hover:shadow-md hover:scale-102 transform duration-200">
        ...
        <div id="mobile-drawer" class="hidden lg:hidden border-t border-slate-200 bg-white px-4 pt-3 pb-6 space-y-2 animate-fade-in-up">
            <a href="<?php echo e(url('/')); ?>" class="block px-3 py-2.5 rounded-lg text-xs font-bold uppercase tracking-wider <?php echo e(request()->is('/') ? 'bg-emerald-50 text-brand-900' : 'text-slate-700 hover:bg-slate-50'); ?>">Beranda</a>
            <a href="<?php echo e(url('/#tentang')); ?>" class="block px-3 py-2.5 rounded-lg text-xs font-bold uppercase tracking-wider text-slate-700 hover:bg-slate-50">Tentang Kami</a>
            <a href="<?php echo e(url('/#layanan')); ?>" class="block px-3 py-2.5 rounded-lg text-xs font-bold uppercase tracking-wider text-slate-700 hover:bg-slate-50">Layanan Penerbitan</a>
            <a href="<?php echo e(url('/#katalog')); ?>" class="block px-3 py-2.5 rounded-lg text-xs font-bold uppercase tracking-wider text-slate-700 hover:bg-slate-50">Katalog Buku</a>
            <a href="<?php echo e(url('/kontak')); ?>" class="block px-3 py-2.5 rounded-lg text-xs font-bold uppercase tracking-wider <?php echo e(request()->routeIs('kontak') ? 'bg-emerald-50 text-brand-900' : 'text-slate-700 hover:bg-slate-50'); ?>">Kontak Redaksi</a>
            <div class="pt-3 border-t border-slate-100">
                <a href="<?php echo e(url('/kontak')); ?>" class="w-full py-3 bg-brand-900 text-white rounded-lg font-bold text-xs uppercase tracking-wider text-center flex items-center justify-center gap-2">
                    <i class="fa-solid fa-cart-shopping text-emerald-400"></i> ORDER ONLINE
                </a>
            </div>
        </div>
    ...
    <footer class="bg-brand-950 text-slate-300 pt-16 pb-12 border-t border-brand-900">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-12 gap-10 pb-12 border-b border-slate-800">
                ...
                <div class="md:col-span-2 space-y-3">
                    ...
                    <ul class="space-y-2 text-xs text-slate-400">
                        <li><a href="<?php echo e(url('/')); ?>" class="hover:text-emerald-400 transition">Beranda</a></li>
                        <li><a href="<?php echo e(url('/#tentang')); ?>" class="hover:text-emerald-400 transition">Tentang Kami</a></li>
                        <li><a href="<?php echo e(url('/#layanan')); ?>" class="hover:text-emerald-400 transition">Layanan</a></li>
                        <li><a href="<?php echo e(url('/#katalog')); ?>" class="hover:text-emerald-400 transition">Katalog Buku</a></li>
                        <li><a href="<?php echo e(url('/kontak')); ?>" class="hover:text-emerald-400 transition">Kontak</a></li>
                    </ul>
                </div>
                ...
                <div class="md:col-span-3 space-y-3">
                    ...
                    <div class="space-y-2 text-xs text-slate-400">
                        <p class="flex items-start gap-2">
                            ...
                            <span><?php echo e(\App\Models\SiteSetting::get('contact_address', 'Gedung Rektorat Lt. 2, Jl. Ciganitri No.2, Bojongsoang, Bandung')); ?></span>
                        </p>
                        <p class="flex items-center gap-2">
                            <i class="fa-brands fa-whatsapp text-emerald-400 shrink-0"></i>
                            <span><?php echo e(\App\Models\SiteSetting::get('contact_whatsapp', '+62 821-1611-6133')); ?></span>
                        </p>
                        <p class="flex items-center gap-2">
                            <i class="fa-solid fa-envelope text-emerald-400 shrink-0"></i>
                            <span><?php echo e(\App\Models\SiteSetting::get('contact_email', 'penerbitan@iaipibandung.ac.id')); ?></span>
                        </p>
                    </div>
                </div>
            ...
            <div class="pt-8 flex flex-col sm:flex-row items-center justify-between text-xs text-slate-500 gap-4">
                <p>&copy; <?php echo e(date('Y')); ?> IAI PERSIS PRESS. All Rights Reserved.</p>
                <div class="flex items-center gap-4">
                    <a href="<?php echo e(route('login')); ?>" class="hover:text-emerald-400 transition flex items-center gap-1">
