...
<?php $__env->startSection('header_title', 'Manajemen Admin & Pengguna'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
        ...
        <a href="<?php echo e(route('admin.users.create')); ?>" class="px-3.5 py-2 bg-emerald-700 hover:bg-emerald-800 text-white rounded-lg text-xs font-semibold transition flex items-center gap-2 shadow-xs">
        ...
        <form method="GET" action="<?php echo e(route('admin.users.index')); ?>" class="grid grid-cols-1 sm:grid-cols-12 gap-3 items-center">
            ...
            <div class="sm:col-span-4">
                <select name="role" class="w-full px-3 py-2 text-xs rounded-lg border border-slate-200 focus:outline-none focus:border-emerald-600 bg-slate-50/50 text-slate-700">
                    ...
                    <option value="admin" <?php echo e(request('role') == 'admin' ? 'selected' : ''); ?>>Admin Biasa</option>
                </select>
            </div>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Gawe\IAIPersis\penerbitan.iaibandung.ac.id\resources\views/admin/users/index.blade.php ENDPATH**/ ?>