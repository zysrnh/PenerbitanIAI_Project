...
class DatabaseSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $settings = [
            ...
            'contact_banner_desc' => 'Konsultasikan naskah buku, kebutuhan cetak, pengurusan ISBN, atau publikasi ilmiah bersama tim IAI Persis Press. Kami siap membantu Anda.',
            ...
            'contact_wa_default_msg' => 'Halo Redaksi IAI PERSIS PRESS, saya ingin berkonsultasi mengenai penerbitan naskah buku.',
            'contact_maps_title' => 'Lokasi Kampus & Percetakan',
            ...
            'notification_recipient_email' => 'hbudiman953@gmail.com',

            // About Us Settings
            'about_banner_badge' => 'Mengenal Lembaga',
            'about_banner_title' => 'Pusat Penerbitan, Percetakan, & Hilirisasi Karya Ilmiah',
            'about_banner_desc' => 'IAI PERSIS PRESS adalah unit penerbitan dan percetakan resmi di bawah naungan Institut Agama Islam Persatuan Islam Bandung, berdedikasi dalam menyebarluaskan khazanah keilmuan Islam dan literasi akademik berkualitas.',
            ...
            'about_feature_4' => 'Pendampingan Naskah Sampai Terbit' penerbitan buku ajar perguruan tinggi, monograf, buku referensi, konversi karya tulis ilmiah (skripsi, tesis, disertasi), hingga jurnal ilmiah. Dilengkapi divisi percetakan mandiri dengan mesin offset dan digital printing modern, kami menjamin kualitas cetak, kerapian tata letak (layout), dan desain sampul yang estetik serta presisi.',
